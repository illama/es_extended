...
function loadESXPlayer(identifier, playerId, isNew)
    ...
    userData.job2 = {
        ...
        grade = tonumber(grade2), -- Utilisation de grade2 au lieu de grade
        grade_name = grade2Object.name, -- Utilisation de grade2Object
...
AddEventHandler("playerDropped", function(reason)
    ...
    if xPlayer then
        ...
        GlobalState[("%s:count"):format(job2)] = ESX.Jobs2PlayerCount[job2]
...
AddEventHandler("esx:setJob2", function(_, job2, lastJob2)
    ...
    local currentLastJob2 = ESX.Jobs2PlayerCount[lastJob2.name]

    ESX.Jobs2PlayerCount[lastJob2.name] = ((currentLastJob2 and currentLastJob2 > 0) and currentLastJob2 or 1) - 1
    ESX.Jobs2PlayerCount[job2.name] = (ESX.Jobs2PlayerCount[job2.name] or 0) + 1

    GlobalState[lastJob2Key] = ESX.Jobs2PlayerCount[lastJob2.name]
    GlobalState[job2Key] = ESX.Jobs2PlayerCount[job2.name]
end)
